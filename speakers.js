const speakers = [
    {
        ...
        description: 'Focusing on a collaborative approach in a networked environment, he created the concept ofco-production based on sharing, such as open source software and Wikipedia.',
    },
    {
        ...
        description: 'By developing Asias first Internet protocol network SDN and leading Koreas first private line Internet connection in 1990, it ushered in the era of the Internet in earnest.',
    },
    {
        image: './icons/speakerimg/speaker_03.png',
        name: 'Sohyeong Noh',
        organize: 'Art Center Nabi Director, CC Korea Director',
        description: 'As the author of [Digital Art Art of Our Time], he opened Art Center Nabi, Koreas first digital art institution in 2000, and is currently serving.',
    },
    {
        image: './icons/speakerimg/speaker_04.png',
        name: 'Julia Reda',
        organize: 'Head of the Young Pirates of Europe',
        description: 'European integration and online youth participation in politics and democracy are major concerns,and a report has been published that will potentially affect the revision of the EUs copyright law in July.',
    },
    {
        image: './icons/speakerimg/speaker_05.png',
        name: 'Lila Tretikov',
        organize: 'Secretary General of the Wikimedia Foundation',
        description: 'Layla Tretikov is the general secretary of the Wikimedia Foundation, a non-profit organization that runs Wikipedia. Wikipedia is provided free of charge in 290 languages ​​every month to over 100 million people, nearly half of the worlds population.',
    },
    {
